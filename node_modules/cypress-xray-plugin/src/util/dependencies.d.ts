import { IPreprocessorConfiguration, resolvePreprocessorConfiguration } from "@badeball/cypress-cucumber-preprocessor";
 ...
 */
export declare function importOptionalDependency<T>(packageName: string): Promise<T>;
/**
 ...
 * @returns the package
 */
export declare const IMPORT: <T>(packageName: string) => Promise<T>;
