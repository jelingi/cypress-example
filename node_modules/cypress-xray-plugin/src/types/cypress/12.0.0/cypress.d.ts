...
export type ConfigOptions<ComponentDevServerOpts = unknown> = Partial<UserConfigOptions<ComponentDevServerOpts>> & {
...
type experimentalCspAllowedDirectives = "child-src" | "default-src" | "form-action" | "frame-src" | "script-src-elem" | "script-src";
...
type DevServerFn<ComponentDevServerOpts = unknown> = (cypressDevServerConfig: DevServerConfig, devServerConfig: ComponentDevServerOpts) => Promise<ResolvedDevServerConfig> | ResolvedDevServerConfig;
...
interface ComponentConfigOptions<ComponentDevServerOpts = unknown> extends Omit<CoreConfigOptions, "baseUrl" | "experimentalStudio"> {
    devServer: DevServerConfigOptions | DevServerFn<ComponentDevServerOpts>;
    devServerConfig?: ComponentDevServerOpts;
    experimentalSingleTabRunMode?: boolean;
}
type UserConfigOptions<ComponentDevServerOpts = unknown> = Omit<ResolvedConfigOptions<ComponentDevServerOpts>, "baseUrl" | "excludeSpecPattern" | "indexHtmlFile" | "specPattern" | "supportFile">;
