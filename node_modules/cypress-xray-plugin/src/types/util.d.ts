...
export type Remap<T extends object, V, E extends number | string | symbol = never> = {
    [K in keyof Required<T>]: Required<T>[K] extends object ? K extends E ? V : Required<T>[K] extends unknown[] ? V : string extends keyof Required<T>[K] ? V : Remap<Required<T>[K], V, E> : V;
};
