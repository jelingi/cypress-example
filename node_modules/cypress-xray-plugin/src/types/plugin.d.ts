 ...
 */
export type InternalJiraOptions = JiraOptions & Required<Pick<JiraOptions, "attachVideos" | "fields" | "projectKey" | "testExecutionIssueType" | "testPlanIssueType" | "url">>;
/**
 ...
 * default/fallback values are used by the plugin.
 */
export type InternalXrayOptions = XrayOptions & Required<Pick<XrayOptions, "status" | "uploadRequests" | "uploadResults" | "uploadScreenshots">>;
/**
 ...
 */
export type HttpOptions = AxiosRequestConfig & Pick<RequestsOptions, "rateLimiting"> & {
    /**
 ...
 * default/fallback values are used by the plugin.
 */
export type InternalPluginOptions = PluginOptions & Required<Pick<PluginOptions, "debug" | "enabled" | "logDirectory" | "normalizeScreenshotNames">>;
/**
